...
import {
  DATE_FORMAT,
  isNotEmptyArray, isNumber,
  MONTH_DATE_FORMAT,
  parseStrToFloatWithDecimal, parseStrToInt,
...
export const mapChartTypes = chartTypes => {
  const result = _.filter(chartTypes, item => _.values(CHAT_CHART_TYPE).includes(item));
