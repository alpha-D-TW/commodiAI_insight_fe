...
import {KNOWLEDGE_TYPE, SUPPORT_TYPE} from '../../constants';
...
const KnowledgeManagement = () => {
    ...
    useEffect(() => {
        const handleFetchFiles = async () => {
            setLoading(true);
            const res = await onGetKnowledgeItems(KNOWLEDGE_TYPE.MARKET_DATA);
            setAllFiles(res);
            setLoading(false);
        };
        handleFetchFiles();
    ...
    return (
        <div style={{
            ...
            {/*    <>*/}
            {/*        <DailyReportList loading={loading} allFiles={allFiles} disableDelete*/}
            {/*                         onRefresh={handleRefreshFiles}/>*/}
            {/*        <UploadDataModal*/}
